...
> **repo-specific (wazuh-dashboard-alerting):** this is a **single OSD plugin**
...
> yarn test:jest               # note: `yarn test:jest`, not `yarn test`
> ```
>
...
2. `yarn` install and `yarn test:jest` pass (in the checkout).

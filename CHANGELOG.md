...
- Fixed misleading index pattern hint in the Create Monitor index field for document level monitors [#8810](https://github.com/wazuh/wazuh-dashboard-plugins/issues/8810)

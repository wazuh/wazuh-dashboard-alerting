...
- Fixed misleading index pattern hint in the Create Monitor index field for document level monitors [#136](https://github.com/wazuh/wazuh-dashboard-alerting/issues/136)

...
This script automates the process of updating the version and stage in the Wazuh Alerting Dashboard plugin repository, using only shell commands.
...
4. **Updates the files**:
   ...
   - `.github/workflows/5_builderpackage_alerting_plugin.yml`: Updates the default value of the `reference` input.
